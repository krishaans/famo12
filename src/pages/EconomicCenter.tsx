...
import CenterMap from '../components/economic-center/CenterMap';
import VegetablePriceList from '../components/economic-center/VegetablePriceList';
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-xl shadow-xl p-8">
            <CenterMap centers={economicCenters} selectedId={id} />
